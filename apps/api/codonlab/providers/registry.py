...
``CODONLAB_PROVIDERS`` names them. An id that resolves to nothing is reported
...
from codonlab.providers.base import Predictor
from codonlab.providers.esm import ESM2_650M
from codonlab.providers.mock import MOCK_FITNESS, MOCK_STABILITY
from codonlab.providers.thermompnn import THERMOMPNN
...
#: Shorthands accepted in ``CODONLAB_PROVIDERS``. ``mock`` turns on the whole
